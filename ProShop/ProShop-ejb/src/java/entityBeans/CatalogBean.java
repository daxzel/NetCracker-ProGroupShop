...
public class CatalogBean implements EntityBean {
    ...
    public java.lang.Long ejbCreate(java.lang.Long id_parent, java.lang.String name) throws CreateException {
        try {
            ejbFindByName(name);
        ...
        try {
            ...
            pst.setLong(1, id_parent.longValue());
            pst.setString(2, name);
    ...
    public void ejbPostCreate(java.lang.Long id_parent, java.lang.String name) throws CreateException  {
    }
