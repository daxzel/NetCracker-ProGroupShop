...
public interface OrderBeanRemoteHome extends EJBHome {
   ...
   // public entityBeans.OrderBeanRemote findByNikAndId(String nik, java.lang.Long id_user) throws FinderException, RemoteException;
    ...
    public java.util.List findOrderByUser(java.lang.Long id_user) throws FinderException, RemoteException;
    
    public java.util.List findByProduct(java.lang.Long id_product) throws FinderException, RemoteException;

    public  entityBeans.OrderBeanRemote  findByUserProductAndSatatus(java.lang.Long id_user,java.lang.Long id_product, boolean status) throws FinderException, RemoteException;
