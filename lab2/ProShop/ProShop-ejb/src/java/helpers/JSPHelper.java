...
public class JSPHelper {
    ...
    private static String adminMenu = " <ul><li class=\"first\">Меню пользователя </li><li><a href=\"basket\">Корзина</a></li><li><a href=\"getOrders\">Заказы</a></li><li><a href=\"add_catalog.jsp\">Добавление нового каталога</a></li><li><a href=\"del_catalog.jsp\">Удаление каталога</a></li><li><a href =\"addProduct.jsp\">Добавление продукта</a></li><li><a href=\"updateProduct.jsp\">Редактировать продукт</a></li><li><a href =\"addProduct.jsp\">Добавление продукта</a></li><li><a href=\"updateUser.jsp?DO=upProf\">Редактирование профиля</a></li><li><a href=\"deleteUser.jsp\">Удалить пользователя</a></li><li><a href=\"updateUser.jsp?DO=upUser\">update user</a></li><li><a href=\"getUsersByRole.jsp\">Поиск пользователей</a></li><li><a href=\"XML/export.jsp\">Экспорт</a></li><li><a href=\"XML/import.jsp\">Импорт</a></li><li class=\"last\"><a href=\"getFullList.jsp\">Вывод всего</a></li></ul>";
