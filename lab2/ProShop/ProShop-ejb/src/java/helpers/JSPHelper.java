...
public class JSPHelper {
    ...
    private static String userMenu = " <ul><li class=\"first\">Меню пользователя </li>   <li><a href=\"/ProShop-war/basket\">Корзина</a></li> <li><a href=\"/ProShop-war/getOrders\">Заказы</a></li><li><a href=\"/ProShop-war/updateUser.jsp?DO=upProf\">Редактирование профиля</a></li><li><a href=\"/ProShop-war/getUsersByRole.jsp\">Поиск пользователей</a></li><li><a href=\"/ProShop-war/getFullList.jsp\">Вывод всего</a></li><li class=\"last\"><a href=\"/ProShop-war/index.jsp\">На главную</a></li></ul>";
    private static String adminMenu = " <ul><li class=\"first\">Меню пользователя </li><li><a href=\"/ProShop-war/basket\">Корзина</a></li><li><a href=\"/ProShop-war/getOrders\">Заказы</a></li><li><a href=\"/ProShop-war/add_catalog.jsp\">Добавление каталога</a></li><li><a href=\"/ProShop-war/updateCatalog.jsp?DO=select\">Редактирование каталога</a></li><li><a href=\"/ProShop-war/del_catalog.jsp\">Удаление каталога</a></li><li><a href =\"/ProShop-war/addProduct.jsp\">Добавление продукта</a></li><li><a href=\"/ProShop-war/updateProduct.jsp\">Изменение продукта</a></li><li><a href =\"/ProShop-war/delProduct.jsp\">Удаление продукта</a></li><li><a href=\"/ProShop-war/updateUser.jsp?DO=upProf\">Редактирование профиля</a></li><li><a href=\"/ProShop-war/deleteUser.jsp\">Удалить пользователя</a></li><li><a href=\"/ProShop-war/updateUser.jsp?DO=upUser\">update user</a></li><li><a href=\"/ProShop-war/getUsersByRole.jsp\">Поиск пользователей</a></li><li><a href=\"/ProShop-war/XML/export.jsp\">Экспорт</a></li> <li><a href=\"/ProShop-war/XML/import.jsp\">Импорт</a></li> <li><a href=\"/ProShop-war/XML/history.jsp\">История (вывод в XML)</a></li><li><a href=\"/ProShop-war/getFullList.jsp\">Вывод всего</a></li><li class=\"last\"><a href=\"/ProShop-war/index.jsp\">На главную</a></li></ul>";
    private static String managerMenu = " <ul><li class=\"first\">Меню пользователя </li><li><a href=\"/ProShop-war/basket\">Корзина</a></li><li><a href=\"/ProShop-war/getOrders\">Заказы</a></li><li><a href=\"/ProShop-war/add_catalog.jsp\">Добавление каталога</a></li><li><a href=\"/ProShop-war/updateCatalog.jsp?DO=select\">Редактирование каталога</a></li><li><a href=\"/ProShop-war/del_catalog.jsp\">Удаление каталога</a></li><li><a href =\"/ProShop-war/addProduct.jsp\">Добавление продукта</a></li><li><a href=\"/ProShop-war/updateProduct.jsp\">Изменение продукта</a></li><li><a href =\"/ProShop-war/delProduct.jsp\">Удаление продукта</a></li><li><a href=\"/ProShop-war/updateUser.jsp?DO=upProf\">Редактирование профиля</a></li><li><a href=\"/ProShop-war/getUsersByRole.jsp\">Поиск пользователей</a></li><li><a href=\"/ProShop-war/getFullList.jsp\">Вывод всего</a></li></ul><li class=\"last\"><a href=\"/ProShop-war/index.jsp\">На главную</a></li></ul>";
